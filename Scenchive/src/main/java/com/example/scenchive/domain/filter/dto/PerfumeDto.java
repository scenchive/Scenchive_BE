...
public class PerfumeDto {
    ...
    public PerfumeDto(Long id, String perfumeName, String perfume_kr, String perfumeImage, String brandName, String brandName_kr, List<Long> keywordIds, double ratingAvg) {
        this.id = id;
